...
main <- function(){
  ...
  if(FALSE){ # FORMER HUC08 + fill-in locations before finding a hydrofabric HUC08 solution:
    ...
    df_huc08_10sqkm <- utils::read.csv(path_huc08_10sqkm)
  ...
  } else { # Generated by bolotinl using hydrofabric HUC08 names embedded in HUC12 ID logic
    df <- utils::read.csv(glue::glue("{dir_base_huc08}/hf_subset_polygons_ngen_concat_comids.csv"))
